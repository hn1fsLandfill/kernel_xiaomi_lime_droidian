...
KERNEL_BOOTIMAGE_CMDLINE = console=ttyMSM0,115200n8 earlycon=msm_geni_serial,0x4a90000 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 androidboot.init_fatal_reboot_target=recovery kpti=off
...
DEVICE_FULL_NAME = Xiaomi Redmi 9T
...
KERNEL_BOOTIMAGE_OS_VERSION = 15.0.0
...
FLASH_INFO_DEVICE_IDS = lime lemon
